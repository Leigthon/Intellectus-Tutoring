...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[320px] h-[320px] sm:w-[560px] sm:h-[560px] lg:w-[800px] lg:h-[800px] opacity-50 pointer-events-none">
      ...
      <div className="absolute bottom-0 right-0 w-[360px] h-[360px] sm:w-[640px] sm:h-[640px] lg:w-[900px] lg:h-[900px] opacity-40 pointer-events-none">
      ...
      <div className="absolute top-1/3 left-1/3 w-[220px] h-[220px] sm:w-[360px] sm:h-[360px] lg:w-[500px] lg:h-[500px] opacity-30 pointer-events-none">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center gap-3 min-h-16 sm:h-20 py-3">
            <Link
              to="/"
              className="text-2xl sm:text-3xl font-black text-[#2c3e73] tracking-tight hover:text-[#1ac8db] transition"
            >
              IS
            </Link>
            ...
            <Link to="/">
              <Button
                variant="ghost"
                className="text-[#2c3e73] hover:text-[#1ac8db] gap-2 text-sm sm:text-lg font-medium"
              >
      ...
      <main className="min-h-screen flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-lg w-full">
          <div className="text-center mb-10 space-y-4">
            ...
            <p className="text-xl sm:text-2xl text-[#1ac8db] font-semibold">
              Welcome Student
            </p>
            <p className="text-gray-600 text-base sm:text-lg font-light max-w-md mx-auto">
          ...
          <Card className="border border-gray-200/50 bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden">
            <CardContent className="p-6 sm:p-10 md:p-12">
              <form onSubmit={handleSubmit} id="login" className="space-y-6 sm:space-y-8" autoComplete="on">
                <div className="space-y-2">
                  <input
                    ...
                    placeholder="Email"
                    required
                    className="w-full px-4 sm:px-5 py-3 sm:py-4 rounded-xl border border-gray-300/70 bg-white/60 focus:outline-none focus:border-[#1ac8db] focus:ring-2 focus:ring-[#1ac8db]/30 transition text-[#2c3e73] placeholder:text-gray-500 text-base sm:text-lg"
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#1ac8db] hover:bg-[#15a3c0] text-white py-5 sm:py-7 text-lg sm:text-xl font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all group flex items-center justify-center gap-3"
                >
