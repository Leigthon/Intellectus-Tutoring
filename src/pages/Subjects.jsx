    ...
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#2c3e73] mb-3">Subjects</h1>
        ...
        <div className="mt-12 flex justify-center">
          <Link to="/contact">
            <Button className="w-full sm:w-auto bg-[#1ac8db] hover:bg-[#15a3c0] text-white px-8 py-3">
              Book a Session
            </Button>
          </Link>
        </div>
